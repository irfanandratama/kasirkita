            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="col-12 text-right">
                        <a href="{{route('cashier-stock.create')}}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> <span>Tambah Aktifitas</span></a>
                    </div>
                    <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        @foreach ($history as $row)                        
                            <tr>
                                ...
                                <td>{{$row->quantity}}</td>
                                <td>
                                    <a href="{{route('cashier-stock.detail', $row->id)}}" class="btn btn-icon btn-info"><i class="fas fa-edit"></i> Detail</a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
